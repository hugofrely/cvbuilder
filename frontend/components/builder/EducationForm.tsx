...
import { Add, Delete, Edit, SchoolOutlined } from '@mui/icons-material';
import { useCVContext } from '@/context/CVContext';
import { Education } from '@/types/cv';

export default function EducationForm() {
  const { cvData, addEducation, updateEducation, deleteEducation } = useCVContext();
          ...
          <Card key={edu.id} variant="outlined">
            <CardContent>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                ...
                <Box>
                  <IconButton size="small" onClick={() => handleEdit(edu)} color="primary">
                    <Edit />
                  </IconButton>
                  <IconButton
                    size="small"
