...
class Command(BaseCommand):
    help = 'Update templates to preserve line breaks in descriptions'
...
<div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px; color: #333;">
    ...
    <section style="margin-bottom: 30px;">
        ...
        <p style="line-height: 1.6; margin: 0; white-space: pre-wrap;">{{summary}}</p>
    </section>
    {{/if}}
...
<div style="font-family: Helvetica, sans-serif; display: flex; min-height: 100vh;">
    ...
    <main style="flex: 1; padding: 40px 50px; background: white;">
        ...
        <section style="margin-bottom: 30px;">
            ...
            <p style="line-height: 1.6; color: #555; white-space: pre-wrap;">{{summary}}</p>
        </section>
        {{/if}}
        ...
        <section style="margin-bottom: 30px;">
            ...
            <div style="position: relative; padding-left: 30px; margin-bottom: 30px;">
                ...
                {{#if description}}
                <p style="color: #555; line-height: 1.6; margin: 0; white-space: pre-wrap;">{{description}}</p>
                {{/if}}
            </div>
            {{/each}}
        </section>
        ...
        <section>
            ...
            <div style="position: relative; padding-left: 30px; margin-bottom: 30px;">
                ...
                {{#if description}}
                <p style="color: #555; line-height: 1.6; margin: 10px 0 0 0; white-space: pre-wrap;">{{description}}</p>
                {{/if}}
            </div>
            {{/each}}
        </section>
...
<div style="font-family: Georgia, serif; max-width: 750px; margin: 0 auto; padding: 60px 40px; color: #333;">
    ...
    <section style="margin-bottom: 40px;">
        <p style="font-size: 16px; line-height: 1.8; color: #666; text-align: center; margin-bottom: 40px; white-space: pre-wrap;">{{summary}}</p>
    </section>
    {{/if}}
    ...
    <section style="margin-bottom: 40px;">
        ...
        <div style="margin-bottom: 30px;">
            ...
            {{#if description}}
            <p style="line-height: 1.6; margin: 0; white-space: pre-wrap;">{{description}}</p>
            {{/if}}
        </div>
        {{/each}}
    </section>
    ...
    <div style="max-width: 900px; margin: -50px auto 0; padding: 0 20px 40px; position: relative;">
        ...
        <div style="background: white; border-radius: 12px; padding: 30px; box-shadow: 0 4px 16px rgba(0,0,0,0.1); display: flex; gap: 20px; margin-bottom: 30px;">
            ...
            <div>
                ...
                <p style="line-height: 1.6; margin: 0; color: #555; white-space: pre-wrap;">{{summary}}</p>
            </div>
        </div>
        {{/if}}
        ...
        self.stdout.write(
            self.style.SUCCESS(f'\n✓ Updated {updated_count} templates to preserve line breaks')
        )
